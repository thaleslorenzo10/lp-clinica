        ...
        <div className="container relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-12 md:mb-20">
            ...
            <p className="mt-4 md:mt-6 text-base md:text-lg text-white/80">
              ...
              tudo com uma comunicação tão natural que seus clientes pensarão estar falando com sua melhor consultora.
            </p>
          </div>
      ...
      <section className="relative py-16 md:py-32 bg-gradient-to-b from-premium-950 to-dark-950">
        ...
        <div className="container relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-12 md:mb-20">
            ...
            <p className="mt-4 md:mt-6 text-base md:text-lg text-white/80">
              A Virtus IA é parceira oficial do Google e Meta, garantindo as melhores práticas e resultados para nossos
              clientes.
            </p>
          </div>
            ...
            <div className="grid gap-8 items-center">
              <PremiumCard variant="glass" className="p-6 md:p-8">
                <div className="flex flex-col items-center">
                  <div className="h-24 md:h-40 w-full relative mb-4 md:mb-6">
                    <Image src="/images/google-partner.jpeg" alt="Google Partner" fill className="object-contain" />
                  </div>
                  ...
                  <p className="text-sm md:text-base text-white/70 text-center">
                    Certificação que reconhece nossa expertise em soluções de publicidade e marketing digital do Google,
                    garantindo estratégias otimizadas para nossos clientes.
                  </p>
                </div>
              </PremiumCard>
              ...
              <PremiumCard variant="glass" className="p-6 md:p-8">
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-sm md:text-base text-white/70 text-center">
                    Parceria que atesta nossa capacidade de desenvolver estratégias eficientes nas plataformas da Meta,
                    incluindo Facebook, Instagram e WhatsApp.
                  </p>
                </div>
              </PremiumCard>
            </div>
            ...
            <div className="mt-8 md:mt-12">
              <GlassCard className="border border-gold-500/20 bg-gold-950/10 text-center p-4 md:p-6">
                <p className="text-sm md:text-base text-white font-medium">
                  ...
                  <span className="text-gold-400 font-bold">melhores práticas e ferramentas</span> de marketing digital
            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-12">
              ...
              <PremiumCard variant="glass" className="p-6 md:p-8">
                ...
                <div className="space-y-4 md:space-y-6 mt-6 md:mt-8">
                  ...
                  <div>
                    <div className="flex justify-between mb-1">
                      <span className="text-xs md:text-sm font-medium text-white">Redução de custos operacionais</span>
